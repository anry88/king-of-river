...
The service currently exposes initialization, cast, hook, finish, client-timeout cast expiration, location selection, and bait selection through the shared tRPC router.

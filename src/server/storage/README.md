...
The current persisted profile version is `4`, which includes `currentBaitId`, active-cast bait locking, shop and daily reward bait inventory, consumable bait counts, and daily reward streak state.
